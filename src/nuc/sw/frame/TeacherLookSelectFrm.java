...
public class TeacherLookSelectFrm extends JInternalFrame {
...
//	}
	 ...
	 * Create the frame.
	 */
	public TeacherLookSelectFrm() {
		setClosable(true);
		setIconifiable(true);
		setBounds(100, 100, 636, 405);
		getContentPane().setLayout(null);
		
		JButton btnNewButton = new JButton("\u67E5\u770B\u9009\u8BFE\u72B6\u6001");
		...
		btnNewButton.setBounds(33, 21, 236, 54);
		getContentPane().add(btnNewButton);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 85, 604, 281);
